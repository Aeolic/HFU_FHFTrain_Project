...
TARGET_NAME=SensRead_T

all : $(TARGET_NAME)$(EXE_EXT) SensRead_T.mak

TARGET_MAIN=MainSensRead_T
...
####################################################################################
$(TARGET_NAME)$(EXE_EXT): $(OBJS) $(ADDITIONAL_OBJS) $(TARGET_MAIN)$(OBJ_EXT) SensRead_T.mak 
...
$(TARGET_NAME)$(LIB_EXT) : $(OBJS) $(ADDITIONAL_OBJS) SensRead_T.mak
