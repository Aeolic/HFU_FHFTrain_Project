...
all : $(TARGET_NAME)$(EXE_EXT) Motor_T.mak

TARGET_MAIN=MainMotor_T
...
####################################################################################
$(TARGET_NAME)$(EXE_EXT): $(OBJS) $(ADDITIONAL_OBJS) $(TARGET_MAIN)$(OBJ_EXT) Motor_T.mak 
...
$(TARGET_NAME)$(LIB_EXT) : $(OBJS) $(ADDITIONAL_OBJS) Motor_T.mak
