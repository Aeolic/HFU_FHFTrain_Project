...
TARGET_NAME=SM_Read_T

all : $(TARGET_NAME)$(EXE_EXT) SM_Read_T.mak

TARGET_MAIN=MainSM_Read_T
...
####################################################################################
$(TARGET_NAME)$(EXE_EXT): $(OBJS) $(ADDITIONAL_OBJS) $(TARGET_MAIN)$(OBJ_EXT) SM_Read_T.mak 
...
$(TARGET_NAME)$(LIB_EXT) : $(OBJS) $(ADDITIONAL_OBJS) SM_Read_T.mak
