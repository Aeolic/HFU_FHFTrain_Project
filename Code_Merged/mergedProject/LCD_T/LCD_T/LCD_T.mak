...
all : $(TARGET_NAME)$(EXE_EXT) LCD_T.mak

TARGET_MAIN=MainLCD_T
...
####################################################################################
$(TARGET_NAME)$(EXE_EXT): $(OBJS) $(ADDITIONAL_OBJS) $(TARGET_MAIN)$(OBJ_EXT) LCD_T.mak 
...
$(TARGET_NAME)$(LIB_EXT) : $(OBJS) $(ADDITIONAL_OBJS) LCD_T.mak
