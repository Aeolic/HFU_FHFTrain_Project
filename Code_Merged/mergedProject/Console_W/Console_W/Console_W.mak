...
TARGET_NAME=Console_W

all : $(TARGET_NAME)$(EXE_EXT) Console_W.mak

TARGET_MAIN=MainConsole_W
...
####################################################################################
$(TARGET_NAME)$(EXE_EXT): $(OBJS) $(ADDITIONAL_OBJS) $(TARGET_MAIN)$(OBJ_EXT) Console_W.mak 
...
$(TARGET_NAME)$(LIB_EXT) : $(OBJS) $(ADDITIONAL_OBJS) Console_W.mak
