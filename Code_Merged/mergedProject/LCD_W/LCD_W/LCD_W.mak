...
all : $(TARGET_NAME)$(EXE_EXT) LCD_W.mak

TARGET_MAIN=MainLCD_W
...
####################################################################################
$(TARGET_NAME)$(EXE_EXT): $(OBJS) $(ADDITIONAL_OBJS) $(TARGET_MAIN)$(OBJ_EXT) LCD_W.mak 
...
$(TARGET_NAME)$(LIB_EXT) : $(OBJS) $(ADDITIONAL_OBJS) LCD_W.mak
