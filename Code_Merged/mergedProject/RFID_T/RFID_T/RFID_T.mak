...
all : $(TARGET_NAME)$(EXE_EXT) RFID_T.mak

TARGET_MAIN=MainRFID_T
...
####################################################################################
$(TARGET_NAME)$(EXE_EXT): $(OBJS) $(ADDITIONAL_OBJS) $(TARGET_MAIN)$(OBJ_EXT) RFID_T.mak 
...
$(TARGET_NAME)$(LIB_EXT) : $(OBJS) $(ADDITIONAL_OBJS) RFID_T.mak
