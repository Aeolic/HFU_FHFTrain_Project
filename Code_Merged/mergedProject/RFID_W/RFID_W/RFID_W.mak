...
all : $(TARGET_NAME)$(EXE_EXT) RFID_W.mak

TARGET_MAIN=MainRFID_W
...
####################################################################################
$(TARGET_NAME)$(EXE_EXT): $(OBJS) $(ADDITIONAL_OBJS) $(TARGET_MAIN)$(OBJ_EXT) RFID_W.mak 
...
$(TARGET_NAME)$(LIB_EXT) : $(OBJS) $(ADDITIONAL_OBJS) RFID_W.mak
