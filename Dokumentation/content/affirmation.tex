...
\vspace*{1.5cm} \par
\line(1,0){200} \par
Furtwangen, den  \docAbgabedatum ~~\docVornameA~\docNachnameA

\vspace*{1.5cm} \par
\line(1,0){200} \par
Furtwangen, den  \docAbgabedatum ~~\docVornameB~\docNachnameB

\vspace*{1.5cm} \par
\line(1,0){200} \par
Furtwangen, den  \docAbgabedatum ~~\docVornameC~\docNachnameC

\vspace*{1.5cm} \par
\line(1,0){200} \par
Furtwangen, den  \docAbgabedatum ~~\docVornameD~\docNachnameD

\vspace*{1.5cm} \par
\line(1,0){200} \par
Furtwangen, den  \docAbgabedatum ~~\docVornameE~\docNachnameE